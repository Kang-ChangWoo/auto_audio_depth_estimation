...
def _args(**over):
    ...
    a = dict(dataset_dir='/home/rvi-lab/workspace/sound-spaces/dataset_simplified',
             ...
             dim=192, n_heads=4, raydpt_win32=3, raydpt_win64=3, time_budget=3600, coarse_norm=False, depth_volume=False, depth_volume_src='e3', depth_out='linear', scale_head=False,
